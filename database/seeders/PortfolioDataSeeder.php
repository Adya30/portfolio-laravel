...
class PortfolioDataSeeder extends Seeder
{
    ...
    {
        $certificates = [
            ['C# Basic Certificate', 'Sertifikat Dasar C#', 'HackerRank', 'December 24, 2025', null, 'ri-code-line', 'Competency certification in basic C# programming covering control structures, basic object-oriented programming, exception handling, and collections.', 'Sertifikasi kompetensi pemrograman dasar C# yang mencakup struktur kendali, pemrograman berorientasi objek dasar, penanganan pengecualian, dan koleksi.'],
            ['Object-Oriented Programming (OOP)', 'Pemrograman Berorientasi Objek (OOP)', 'dicoding', 'December 17, 2025', null, 'ri-instance-line', 'Certification of understanding in object-oriented programming paradigm covering Encapsulation, Inheritance, Polymorphism, and Abstraction.', 'Sertifikasi pemahaman paradigma pemrograman berorientasi objek yang mencakup Enkapsulasi, Pewarisan, Polimorfisme, dan Abstraksi.'],
            ['C Programming', 'Pemrograman C', 'Dicoding', 'December 14, 2025', null, 'ri-code-box-line', 'Fundamental understanding of procedural programming with C language, memory management, pointers, array manipulation, and basic data structures.', 'Pemahaman fundamental pemrograman prosedural dengan bahasa C, manajemen memori, pointer, manipulasi array, dan struktur data dasar.'],
            ['Junior Web Developer Certification', 'Sertifikasi Junior Web Developer', 'PT. Inixindo', 'November 05 - 08, 2025', null, 'ri-global-line', 'Official national competency certification as a Junior Web Developer, validating skills in HTML, CSS, JavaScript, relational databases, and static/dynamic web implementations.', 'Sertifikasi kompetensi nasional resmi sebagai Junior Web Developer, memvalidasi keterampilan HTML, CSS, JavaScript, database relasional, dan implementasi web statis/dinamis.'],
            ['2nd Place in Game Development Competition', 'Juara 2 Lomba Pengembangan Game', 'HMIF', 'October 19, 2025', null, 'ri-gamepad-fill', 'Award for achieving second place in a national creative game development competition, focusing on game mechanics design, asset integration, and gameplay.', 'Penghargaan meraih juara kedua dalam lomba pengembangan game kreatif tingkat nasional, berfokus pada desain mekanik game, integrasi aset, dan gameplay.'],
            ['Programming Division Member', 'Anggota Divisi Programming', 'UKM LAOS', 'December 1, 2025', null, 'ri-team-line', 'Certification of leadership and dedication as a programming staff member in the information technology community, mentoring members in understanding basic programming algorithms.', 'Sertifikasi kepemimpinan dan dedikasi sebagai staf programming di komunitas teknologi informasi, mendampingi anggota dalam memahami algoritma pemrograman dasar.'],
            ['IT Staff SMAGITV', 'Staf IT SMAGITV', 'SMAN 1 Giri', 'October 13, 2023', null, 'ri-tv-line', 'Award for active contribution as information technology staff and school digital media broadcast management, designing local network infrastructure and live streaming portals.', 'Penghargaan atas kontribusi aktif sebagai staf teknologi informasi dan pengelola siaran media digital sekolah, merancang infrastruktur jaringan lokal dan portal live streaming.'],
            ['Gold Medal in Physics Olympiad', 'Medali Emas Olimpiade Fisika', 'OPN', 'October 30, 2022', null, 'ri-award-fill', 'Gold medal award in a national level academic competition in the field of Physics, validating logical analysis and complex problem-solving abilities.', 'Medali emas dalam kompetisi akademik tingkat nasional bidang Fisika, memvalidasi kemampuan analisis logis dan pemecahan masalah kompleks.'],
            ['Bronze Medal in Informatics Olympiad', 'Medali Perunggu Olimpiade Informatika', 'OPN', 'October 30, 2022', null, 'ri-award-line', 'Bronze medal award in a national level Informatics competition, testing algorithm skills, data structures, and competitive programming problem-solving.', 'Medali perunggu dalam kompetisi Informatika tingkat nasional, menguji keterampilan algoritma, struktur data, dan pemecahan masalah pemrograman kompetitif.'],
            ['SEO & Content Marketing', 'SEO & Content Marketing', 'MySkill', 'January 13, 2025', null, 'ri-line-chart-line', 'Certification in Search Engine Optimization (SEO) strategies covering keyword research, on-page optimization, technical SEO, and performance measurement to improve website visibility and organic search rankings.', 'Sertifikasi strategi Search Engine Optimization (SEO) yang mencakup riset kata kunci, optimasi on-page, SEO teknis, dan pengukuran kinerja untuk meningkatkan visibilitas website dan peringkat pencarian organik.'],
            ['Getting Prospective Clients', 'Mendapatkan Calon Klien', 'MySkill', 'January 16, 2025', null, 'ri-handshake-line', 'Certification in digital marketing client acquisition strategies, covering lead generation, conversion optimization, market analysis, and client relationship management for effective business growth.', 'Sertifikasi strategi akuisisi klien pemasaran digital, mencakup pembuatan prospek (lead generation), optimasi konversi, analisis pasar, dan manajemen hubungan klien untuk pertumbuhan bisnis yang efektif.'],
        ];

        foreach ($certificates as $i => [$nama, $nama_idn, $penerbit, $tanggal, $gambar, $icon, $desk, $desk_idn]) {
