    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <header class="text-center mb-10 sm:mb-12" data-aos="fade-up" data-aos-duration="600">
            <h1 class="font-poppins text-3xl sm:text-4xl md:text-5xl font-bold text-slate-900 dark:text-white tracking-tight mb-3 leading-tight">
                <span x-text="t('courseTitle')">Learning Materials</span>
            </h1>

            <p class="max-w-2xl mx-auto text-base sm:text-lg text-slate-600 dark:text-slate-300 leading-relaxed"
               x-text="t('courseSubtitle')">
                Collection of structured learning materials to sharpen your skills in web development, programming, and UI design.
            </p>
        </header>
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                @foreach ($courses as $i => $course)
                    ...
                    <a href="{{ route('course.show', $course) }}"
                       class="group block bg-white dark:bg-[#0f172a] border border-slate-200 dark:border-white/10 rounded-2xl overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-slate-200/50 dark:hover:shadow-black/30"
