...
@section('content')
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            <div class="grid lg:grid-cols-3 items-center gap-8 lg:gap-8 w-full">
                ...
                <div class="flex justify-center order-1 lg:order-2 animate__animated animate__fadeInUp animate__delay-2s">
                    <div class="relative w-full max-w-4xl mx-auto flex flex-col items-center pb-6">
    ...
    <section class="py-16 sm:py-20 relative z-10 scroll-mt-20" id="tentang">
        <div class="text-center mb-14">
            ...
            <p class="mt-3 mx-auto text-[0.95rem] text-slate-500 dark:text-slate-400 max-w-lg" x-text="t('aboutSubtitle')">A
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <div class="flex flex-wrap gap-2 mt-6">
                        @foreach ($chips as $chip)
                            <span
                                class="px-3 py-1.5 text-xs font-medium rounded-full bg-slate-100 dark:bg-white/5 text-slate-600 dark:text-slate-400 border border-slate-200 dark:border-white/5 hover:border-accent/30 hover:text-accent dark:hover:text-accent transition-all duration-200 cursor-default">{{ $chip }}</span>
                        @endforeach
                    </div>
                </div>
            </div>
    ...
    <section class="py-16 sm:py-20 relative z-10 scroll-mt-20" id="experiences">
        <div class="text-center mb-14">
            <h2 class="font-poppins text-[1.75rem] sm:text-4xl font-bold leading-[1.2] text-slate-800 dark:text-slate-100">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="relative">
                ...
                <div class="absolute left-6 top-1 bottom-1 w-0.5 rounded-full bg-linear-to-b from-accent/50 via-slate-200 dark:via-white/10 to-transparent"
                ...
                <template x-for="(e, i) in experiences" :key="e.id">
                    <div class="relative pl-14 sm:pl-16 mb-10 md:mb-12 last:mb-0">
                        ...
                        <span
                            class="absolute left-6 top-2.5 -translate-x-1/2 w-4 h-4 rounded-full border-4 border-slate-50 dark:border-[#0a0a0f] shadow-sm transition-all duration-300"
                            :class="i === 0 ?
                        ...
                        <a :href="e.url" class="block group w-full">
                            <div
                                ...
                                <div class="flex items-start gap-4 mb-4">
                                    <span
                                        class="w-12 h-12 sm:w-14 sm:h-14 rounded-xl shrink-0 overflow-hidden bg-accent/10 dark:bg-accent/15 flex items-center justify-center font-poppins font-bold text-lg text-accent dark:text-[#60a5fa] border border-slate-200 dark:border-white/5">
                                    ...
                                    <div class="min-w-0 flex-1">
                                        <div class="flex items-center justify-between gap-3 mb-1">
                                            <span
                                                class="inline-flex items-center gap-1.5 text-[11px] font-bold uppercase tracking-widest text-accent dark:text-[#60a5fa] min-w-0">
                                                <span class="truncate" x-text="e.company"></span>
                                            </span>
                                            <span
                                                class="text-[11px] font-bold text-slate-300 dark:text-slate-600 select-none shrink-0"
                                                x-text="String(i + 1).padStart(2, '0')"></span>
                                        </div>
                                        <h3 class="text-lg sm:text-xl font-bold text-slate-800 dark:text-slate-100 group-hover:text-accent transition-colors leading-snug"
                                            x-text="L(e.role, e.roleIdn)"></h3>
                                    </div>
                                </div>

                                <div
                                    class="flex flex-wrap items-center gap-x-4 gap-y-1.5 mt-3 mb-4 text-xs text-slate-500 dark:text-slate-400">
                                    <span
                                        class="inline-flex items-center gap-1.5 font-semibold px-2.5 py-1 rounded-full bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/5 whitespace-nowrap">
                                ...
                                <template x-if="e.practicumDesc">
                                    <div
                                        class="mb-4 bg-slate-100/50 dark:bg-white/5 p-4 rounded-xl border border-slate-200/30 dark:border-white/5">
                                        <h4 class="text-xs font-bold uppercase tracking-wider text-slate-700 dark:text-slate-400 mb-2"
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <ul class="space-y-2">
                                            <template x-for="(r, ri) in L(e.responsibilities, e.responsibilitiesIdn)"
                                                :key="ri">
                                                <li
                                                    class="text-sm text-slate-500 dark:text-slate-400 flex items-start gap-2">
                                                    <i
                                ...
                                <template x-if="e.skills && e.skills.length > 0">
                                    <div class="pt-3 border-t border-slate-100 dark:border-white/5">
                                        <div class="flex flex-wrap gap-1.5 items-center">
                                            <span class="text-xs text-slate-400 dark:text-slate-500 mr-1 font-medium"
                                                x-text="t('skillsLabel')">Skills:</span>
                                            <template x-for="(s, si) in e.skills" :key="si">
                                                <span
                                                    class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium text-accent dark:text-[#60a5fa] bg-accent/10 dark:bg-accent/15 border border-accent/15 dark:border-accent/25 transition-all duration-200 hover:bg-accent/15 hover:-translate-y-px"
                                                    x-text="s"></span>
                                            </template>
                                        </div>
                                    </div>
                                ...
                                <div
                                    class="pt-4 mt-4 border-t border-slate-100 dark:border-white/5 flex items-center justify-between">
                                    <span
    ...
    <section class="py-16 sm:py-20 relative z-10 scroll-mt-20" id="certificates">
        <div class="text-center mb-12">
            <h2 class="font-poppins text-[1.75rem] sm:text-4xl font-bold leading-[1.2] text-slate-800 dark:text-slate-100">
    ...
    <section class="py-16 sm:py-20 relative z-10 scroll-mt-20" id="kontak">
        <div class="text-center mb-12">
            <h2 class="font-poppins text-[1.75rem] sm:text-4xl font-bold leading-[1.2] text-slate-800 dark:text-slate-100">
